...
namespace Gameplay.Layout.Design.Backgrounds
{
    internal class MoonBackground : MonoBehaviour, IBackground
    {
        public MoonTransition TransitionType
        {
            set
            {
                ...
                {
                    MoonTransition.FromLeftToRight => new Vector3(-SharedConstants.CameraWidth, 0, z),
                    MoonTransition.FromRightToLeft => new Vector3(SharedConstants.CameraWidth, 0, z),
                    MoonTransition.FromBottomToUp => new Vector3(0, -SharedConstants.CameraHeight, z),
                    MoonTransition.FromUpToBottom => new Vector3(0, SharedConstants.CameraHeight, z),
